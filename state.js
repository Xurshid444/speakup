...
// ════════════════════════════
const S={groqKey:localStorage.getItem('speakup_groq_key')||'',elKey:'',level:'A1',accent:'en-US',feedbackLang:'uz',speed:1.0,model:'llama-3.3-70b-versatile',elVoice:'21m00Tcm4TlvDq8ikWAM',pickedVoice:null,currentLesson:null,bookHist:[],freeHist:[],vocMode:'uz-en',vocLesson:null,vocWords:[],vocIdx:0,vocScore:0,vocWrong:[]};
