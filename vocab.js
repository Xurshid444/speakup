...
function showVocWord(){
  ...
  area.innerHTML=`
    <div class="vcard"><div class="vc-progress">${S.vocIdx+1} / ${S.vocWords.length}</div><div class="vc-label">${isUzEn?"O'zbekcha so'z:":"Inglizcha so'z:"}</div><div class="vc-word">${prompt.charAt(0).toUpperCase()+prompt.slice(1)}</div><div class="vc-hint">${isUzEn?"Inglizcha tarjimasini ayting":"O'zbekcha tarjimasini ayting"} 🎤</div><div class="vc-result" id="vc-res"></div></div>
